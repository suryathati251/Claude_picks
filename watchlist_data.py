...
WATCHLIST = [
    ...
    # ---- ADDED on request: ODD / FI(Fiserv) / CPNG / KLAR / PATH / ELF / PINS ----
    {"ticker": "ODD", "region": "US", "name": "Oddity Tech", "sector": "Consumer/Comm", "target": None,
     "thesis": "AI/data-driven beauty & wellness (Il Makiage, SpoiledChild); profitable hypergrowth, high margins, DTC model.",
     "catalyst": "New brand launches; Oddity Labs biotech pipeline; margin expansion",
     "risk": "Beauty-fad risk; DTC ad-cost sensitivity; concentration in two brands"},
    {"ticker": "FI", "region": "US", "name": "Fiserv (ex-FISV)", "sector": "Financials", "target": None,
     "thesis": "Payments & fintech infrastructure (Clover POS, merchant + issuer processing); steady FCF compounder. NOTE: FISV re-listed on NYSE as 'FI'.",
     "catalyst": "Clover GPV growth; merchant/issuer volume; buybacks",
     "risk": "Payments competition; consumer-spend sensitivity; integration/debt"},
    {"ticker": "CPNG", "region": "US", "name": "Coupang", "sector": "Consumer/Comm", "target": None,
     "thesis": "Dominant Korean e-commerce ('Rocket' logistics) scaling profitability + new verticals (Taiwan, Eats, ads).",
     "catalyst": "Developing Offerings margin; international expansion; ads growth",
     "risk": "Korea competition (AliExpress/Temu); international investment drag; FX"},
    {"ticker": "KLAR", "region": "US", "name": "Klarna Group", "sector": "Financials", "target": None,
     "thesis": "Global BNPL / neobank scaling toward profitability with AI-driven cost cuts. Recently public — financial history may be thin.",
     "catalyst": "US growth; take-rate; credit-loss control; profitability ramp",
     "risk": "Credit-cycle exposure; BNPL regulation; competition (Affirm/Apple); newly listed"},
    {"ticker": "PATH", "region": "US", "name": "UiPath", "sector": "Software", "target": None,
     "thesis": "RPA/automation platform pivoting to agentic AI; sticky enterprise base but decelerating growth. Turnaround.",
     "catalyst": "Agentic-AI product adoption; net-retention stabilization; FCF",
     "risk": "Growth deceleration; Microsoft competition; SBC dilution"},
    {"ticker": "ELF", "region": "US", "name": "e.l.f. Beauty", "sector": "Consumer/Comm", "target": None,
     "thesis": "Fast-growing value cosmetics taking shelf share; strong Gen-Z brand + digital. Premium multiple.",
     "catalyst": "Retail shelf-space gains; international; Naturium/skincare lines",
     "risk": "Rich valuation; tariff/China sourcing; category cyclicality; deceleration"},
    {"ticker": "SNAP", "region": "US", "name": "Snap Inc.", "sector": "Consumer/Comm", "target": None,
     "thesis": "Snapchat ads + subscriptions (Snapchat+); AR platform optionality; DR-ad rebuild underway.",
     "catalyst": "Ad-platform improvements; Snapchat+ subscriber growth; AR/Specs roadmap",
     "risk": "Meta/TikTok competition; ad-cycle sensitivity; persistent dilution/SBC; thin profitability"},
    {"ticker": "PINS", "region": "US", "name": "Pinterest", "sector": "Consumer/Comm", "target": None,
